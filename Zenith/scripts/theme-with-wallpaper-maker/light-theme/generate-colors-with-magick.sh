...
COLOR_1_HSL=$(hex_to_hsl_with_l "${IM_COLORS[1]}" 25)
COLOR_2_HSL=$(hex_to_hsl_with_l "${IM_COLORS[2]}" 30)
COLOR_3_HSL=$(hex_to_hsl_with_l "${IM_COLORS[3]}" 35)
COLOR_4_HSL=$(hex_to_hsl_with_l "${IM_COLORS[4]}" 40)
COLOR_5_HSL=$(hex_to_hsl_with_l "${IM_COLORS[5]}" 45)
COLOR_6_HSL=$(hex_to_hsl_with_l "${IM_COLORS[6]}" 50)
COLOR_7_HSL=$(hex_to_hsl_with_l "${IM_COLORS[7]}" 55)
COLOR_8_HSL=$(hex_to_hsl_with_l "${IM_COLORS[8]}" 60)
COLOR_9_HSL=$(hex_to_hsl_with_l "${IM_COLORS[9]}" 65)
COLOR_10_HSL=$(hex_to_hsl_with_l "${IM_COLORS[10]}" 70)
COLOR_11_HSL=$(hex_to_hsl_with_l "${IM_COLORS[11]}" 75)
COLOR_12_HSL=$(hex_to_hsl_with_l "${IM_COLORS[12]}" 80)
COLOR_13_HSL=$(hex_to_hsl_with_l "${IM_COLORS[13]}" 85)
COLOR_14_HSL=$(hex_to_hsl_with_l "${IM_COLORS[14]}" 85)
...
BG=$(hsl_to_hex "$COLOR_15_HSL")
FG=$(hsl_to_hex "$COLOR_0_HSL")
